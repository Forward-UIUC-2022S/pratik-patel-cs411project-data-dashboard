...
class DB():
    def __init__(self):
        try: self.Affiliation_df: pd.DataFrame = pd.read_csv("Data/Affiliation.csv", index_col=False)
        except: 
        ...
        try: self.Keyword_df: pd.DataFrame = pd.read_csv("Data/Keyword.csv", index_col=False)
        except: 
        ...
        try: self.Faculty_df: pd.DataFrame = pd.read_csv("Data/Faculty.csv", index_col=False)
        except: 
